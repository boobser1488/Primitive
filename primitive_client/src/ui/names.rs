...
pub const BLOCKS: &[Name] = &[
    ...
    Name { id: "map", en: "Map", simple: "Map of where you walked", ru: "Карта", pl: "Mapa" },
    Name { id: "blaze", en: "Blaze", simple: "Cut mark on a tree", ru: "Зарубка", pl: "Zacios" },
    ...
    Name { id: "handful_gravel", en: "Handful of gravel", simple: "Some gravel", ru: "Горсть гравия", pl: "Garść żwiru" },
    Name { id: "handful_clay", en: "Handful of clay", simple: "Some clay", ru: "Ком глины", pl: "Grudka gliny" },
    Name { id: "stone_chips", en: "Stone chips", simple: "Small broken stones", ru: "Каменная крошка", pl: "Okruchy kamienia" },
    Name { id: "quicklime", en: "Quicklime", simple: "Burnt lime", ru: "Негашёная известь", pl: "Wapno palone" },
    Name { id: "mortar", en: "Mortar", simple: "Brick glue", ru: "Раствор", pl: "Zaprawa" },
    Name { id: "daub", en: "Daub", simple: "Clay and straw mud", ru: "Обмазка", pl: "Polepa" },
    Name { id: "cob", en: "Cob", simple: "Mud and straw lump", ru: "Саман", pl: "Glina ze słomą" },
    Name { id: "brick_courses", en: "Brick courses", simple: "Brick wall, half built", ru: "Кирпичная кладка на растворе", pl: "Mur z cegieł na zaprawie" },
    Name { id: "dry_bricks", en: "Dry-laid bricks", simple: "Bricks without mortar", ru: "Кирпич всухую", pl: "Cegły na sucho" },
    Name { id: "dry_stone_wall", en: "Dry stone wall", simple: "Stacked stone wall", ru: "Сухая каменная кладка", pl: "Murek z kamieni" },
    Name { id: "wattle", en: "Wattle", simple: "Woven stick wall", ru: "Плетень", pl: "Plecionka" },
    Name { id: "cob_wall", en: "Cob wall", simple: "Mud wall", ru: "Саманная стена", pl: "Ściana z gliny" },
    ...
    Name { id: "copper_saw", en: "Copper saw", simple: "Copper saw", ru: "Медная пила", pl: "Miedziana piła" },
...
pub const RECIPES: &[Name] = &[
    ...
    Name { id: "clay mortar", en: "Clay mortar", simple: "Mud brick glue", ru: "Глиняный раствор", pl: "Zaprawa gliniana" },
    ...
    Name { id: "copper saw", en: "Copper saw", simple: "Copper saw", ru: "Медная пила", pl: "Miedziana piła" },
    Name { id: "bronze saw", en: "Bronze saw", simple: "Bronze saw", ru: "Бронзовая пила", pl: "Brązowa piła" },
    Name { id: "iron saw", en: "Iron saw", simple: "Iron saw", ru: "Железная пила", pl: "Żelazna piła" },
    Name { id: "sawn planks", en: "Sawn planks", simple: "Boards cut with a saw", ru: "Пилёные доски", pl: "Deski piłowane" },
    Name { id: "sawn birch", en: "Sawn birch", simple: "Birch boards cut with a saw", ru: "Пилёная берёза", pl: "Piłowana brzoza" },
    Name { id: "sawn fir", en: "Sawn fir", simple: "Fir boards cut with a saw", ru: "Пилёная ель", pl: "Piłowana jodła" },
    Name { id: "sawn saxaul", en: "Sawn saxaul", simple: "Saxaul boards cut with a saw", ru: "Пилёный саксаул", pl: "Piłowany saksauł" },
    ...
    Name { id: "map", en: "Map", simple: "Map of where you walked", ru: "Карта", pl: "Mapa" },
    Name { id: "cut map", en: "Cut a map", simple: "Map, cheaper at the bench", ru: "Раскроить карту", pl: "Wykroić mapę" },
    Name { id: "stall", en: "Barter stall", simple: "Trading table", ru: "Меновой прилавок", pl: "Stragan wymienny" },
    Name { id: "pack earth", en: "Pack earth", simple: "Earth block", ru: "Сбить землю", pl: "Ubić ziemię" },
